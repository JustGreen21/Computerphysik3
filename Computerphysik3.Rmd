...
Für den Ausgebruch einer Krankheit in Deutschland sind die Anfangswerte gegeben wie folgt.\\
...
\begin{equation}
  \frac{S}{N} = \frac{1}{R_0}
\end{equation}
Dazu tragen wir am Ende der Pandemie (d.h.$I(t) < 0$) das Verhältnis der noch nicht Infizierten $S(t)$ gegenüber der Gesammtbevölkerung $N$ in Abhänigkeit von $R_0$ auf. Zum Vergleich betrachten wir auch den nach der Herdinimunität erwarteten Kurvenverlauf. 
